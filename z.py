...
def helpmessage():
    helpMessage = "╔═══════════════" + "\n" + \
                  ...
                  "╠➥ โปรไฟล์วีดีโอเรา" + "\n" + \
                  "╠➥ ปกเรา" + "\n" + \
                  "╠➥ ขโมยContact「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ขโมยmid「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ขโมยชื่อ「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ขโมยคำอธิบาย「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ขโมยโปรไฟล์「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ขโมยโปรไฟล์วีดีโอ「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ขโมยปก「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ย้ายร่าง「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ กลับร่าง" + "\n" + \
                  "║" + "\n" + \
                  "╠✪〘 กลุ่ม 〙✪════════" + "\n" + \
                  "╠➥ คนสร้างกลุ่ม" + "\n" + \
                  ...
                  "╠➥ สมาชิกในกลุ่ม" + "\n" + \
                  "╠➥ กลุ่ม?" + "\n" + \
                  "╠➥ Kill「ปิดการทำงานกันบินกลุ่ม」" + "\n" + \
                  "╠➥ KickAllMember「ปิดการทำงานกันบินกลุ่ม」"+ "\n" + \
                  "║" + "\n" + \
                  "╠✪〘 แถม 〙✪═══════" + "\n" + \
                  "╠➥ ล้อคน「On/Off」" + "\n" + \
                  "╠➥ รายชื่อคนที่ล้อ" + "\n" + \
                  "╠➥ เพิ่มล้อคน「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ ลบล้อคน「@คนที่ต้องการ」" + "\n" + \
                  "╠➥ แทกทุกคน" + "\n" + \
                  "╠➥ ใครแอบ「Oɴ/Off/Reset」" + "\n" + \
                  "╠➥ ใครแอบ" + "\n" + \
                  "║" + "\n" + \
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                nadya.sendMessage(op.param1, "สวัสดี {} ขอบคุณที่แอดโผมมานะคับ:D".format(str(nadya.getContact(op.param1).displayName)))
        if op.type == 13:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
#==============================================================================#
                if text.lower() == 'ช่วยด้วย':
                    helpMessage = helpmessage()
                    nadya.sendMessage(to, str(helpMessage))
                    nadya.sendContact(to, "ue5be3cf068952637e77d345c652b3497")
...
#==============================================================================#
                    ...
                    start = time.time()
                    nadya.sendMessage(to, "กำลังทดสอบความเร็ว...")
                    elapsed_time = time.time() - start
                    nadya.sendMessage(to,format(str(elapsed_time)))
                elif text.lower() == 'รี':
                    nadya.sendMessage(to, "กำลังรีสตาฟค๊าบ")
                    time.sleep(5)
                    nadya.sendMessage(to, "รีสตาฟแล้วไปเอาลิ้งจากTERMUXมาล็อกอินค๊าบ")
                    restartBot()
                elif text.lower() == 'runtime':
                    timeNow = time.time()
                    runtime = timeNow - botStart
                    runtime = format_timespan(runtime)
                    nadya.sendMessage(to, "บอทรันไปแล้ว {}".format(str(runtime)))
                elif text.lower() == 'about':
                    try:
                        arr = []
                        owner = "ue5be3cf068952637e77d345c652b3497
                        ...
                        ret_ += "\n╠ บล็อก : {}".format(str(len(blockedlist)))
                        ret_ += "\n╠══[ About Selfbot ]"
                        ret_ += "\n╠ เวอร์ชั้น : Beta V.3"
                        ret_ += "\n╠ ผู้สร้าง : ZereZGz"
                        ret_ += "\n╠ คำอธิบย : บางคำสั้งอาจจะใช้งานไม่ได้เนื่องจากเป็นตัวBetaกำลังแก้ไขขอบคุณครับ"
                        ret_ += "\n╚══[ Editby ZereZGz :D ]"
...
#==============================================================================#
                    ...
                    nadya.sendMessage(to, "เปิดออโต้แอดแล้วคับ")
                elif text.lower() == 'autoadd off':
                    settings["autoAdd"] = False
                    nadya.sendMessage(to, "ปิดออโต้แอดแล้วคับ")
                elif text.lower() == 'autojoin on':
                    settings["autoJoin"] = True
                    nadya.sendMessage(to, "เปิดเข้าห้องออโต้แล้วคับ")
                elif text.lower() == 'autojoin off':
                    settings["autoJoin"] = False
                    nadya.sendMessage(to, "ปิดเข้าห้องออโต้แล้วคับ")
                elif text.lower() == 'autoleave on':
                    settings["autoLeave"] = True
                    nadya.sendMessage(to, "เปิดออโต้ออกห้องแล้วคับ")
                elif text.lower() == 'autojoin off':
                    settings["autoLeave"] = False
                    nadya.sendMessage(to, "ปิดออโต้ออกห้องแล้วคับ")
                elif text.lower() == 'autoread on':
                    settings["autoRead"] = True
                    nadya.sendMessage(to, "เปิดออโต้อ่านแล้วคับ")
                elif text.lower() == 'autoread off':
                    settings["autoRead"] = False
                    nadya.sendMessage(to, "ปิดออโต้อ่านแล้วคับ")
                elif text.lower() == 'checksticker on':
                    settings["checkSticker"] = True
                    nadya.sendMessage(to, "เปิดเชคสติกเกอร์แล้วคับ")
                elif text.lower() == 'checksticker off':
                    settings["checkSticker"] = False
                    nadya.sendMessage(to, "ปิดเชตสติกเกอร์แล้วคับ")
                elif text.lower() == 'detectmention on':
                    settings["datectMention"] = True
                    nadya.sendMessage(to, "เปิดแล้วคับ")
                elif text.lower() == 'detectmention off':
                    settings["datectMention"] = False
                    nadya.sendMessage(to, "ปิดแล้วคับ")
...
#==============================================================================#
                ...
                elif msg.text.lower().startswith("ขโมยcontact "):
                ...
                elif msg.text.lower().startswith("ขโมยmid "):
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                ...
                elif msg.text.lower().startswith("ขโมยคำอธิบาย "):
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                ...
                elif msg.text.lower().startswith("ขโมยโปรไฟล์ "):
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                ...
                elif msg.text.lower().startswith("ขโมยโปรไฟล์วีดีโอ "):
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                    ...
                    if line != None:
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for ls in lists:
                                ...
                                nadya.sendImageWithURL(msg.to, str(path))
                elif msg.text.lower().startswith("ย้ายร่าง "):
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                        ...
                        try:
                            ...
                            nadya.sendMessage(msg.to, "ย้ายร่างสำเร็จแล้ว")
                        except:
                            nadya.sendMessage(msg.to, "ย้ายร่างสำเร็จแล้ว")
                    ...
                    try:
                        ...
                        nadya.sendMessage(msg.to, "กลับร่างเรียบร้อย")
                    except:
                        nadya.sendMessage(msg.to, "ไม่สามารถกลับร่างได้")
                        
#==============================================================================#
                elif msg.text.lower().startswith("เพิ่มล้อคน "):
                    targets = []
                    ...
                    for target in targets:
                        try:
                            ...
                            nadya.sendMessage(msg.to,"เพิ่มล้อคนแล้วคับ")
                            break
                        except:
                            nadya.sendMessage(msg.to,"ไม่สามารถเพิ่มได้")
                            break
                elif msg.text.lower().startswith("ลบล้อคน "):
                    targets = []
                    key = eval(msg.contentMetadata["MENTION"])
                    key["MENTIONEES"][0]["M"]
                    for x in key["MENTIONEES"]:
                    ...
                    for target in targets:
                        try:
                            ...
                            nadya.sendMessage(msg.to,"ลบล้อคนเรียบร้อย")
                            break
                        except:
                            nadya.sendMessage(msg.to,"ไม่สามารถลบได้")
                            break
                elif text.lower() == 'รายชื่อคนที่ล้อ':
                ...
                elif "ล้อคน" in msg.text.lower():
                    sep = text.split(" ")
                    mic = text.replace(sep[0] + " ","")
                    if mic == "on":
                        if settings["mimic"]["status"] == False:
                            settings["mimic"]["status"] = True
                            nadya.sendMessage(msg.to,"เริ่มการล้อ:P")
                    elif mic == "off":
                        if settings["mimic"]["status"] == True:
                            settings["mimic"]["status"] = False
                            nadya.sendMessage(msg.to,"ปิดการล้อ:P")
#==============================================================================#
                elif text.lower() == 'คนสร้างกลุ่ม':
                    group = nadya.getGroup(to)
                    GS = group.creator.mid
                    nadya.sendContact(to, GS)
                elif text.lower() == 'idกลุ่ม':
                    ...
                    if msg.toType == 2:
                        group = nadya.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            nadya.sendMessage(to, "เปิดเข้าห้องด้วยqrแล้ว")
                        else:
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == True:
                            nadya.sendMessage(to, "ปิดเข้าห้องด้วยqrแล้ว")
                        else:
                    ...
                    ret_ += "\n╠ คนทั้งหมดในกลุ่ม : {}".format(str(len(group.members)))
...
#==============================================================================#          
                    ...
                    if msg.to in read['readPoint']:
                            ...
                            with open('read.json', 'w') as fp:
                                ...
                                nadya.sendMessage(msg.to,"เปิดดูใครแอบ")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                    ...
                    if msg.to in read["readPoint"]:
                        try:
                            ...
                            pass
                        nadya.sendMessage(msg.to, "Resetเรียบร้อยครับ:\n" + readTime)
                    else:
                        nadya.sendMessage(msg.to, "คุณต้องเปิดใช้งานก่อนถึงจะResetได้")
                        
                elif text.lower() == 'ใครแอบ':
                    tz = pytz.timezone("Asia/Jakarta")
                    timeNow = datetime.now(tz=tz)
                    day = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday","Friday", "Saturday"]
                    hari = ["Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"]
                    ...
                    if receiver in read['readPoint']:
                        ...
                        nadya.sendMessage(receiver,"ยังไม่ได้ตั้งค่าใครแอบ")
#==============================================================================#
